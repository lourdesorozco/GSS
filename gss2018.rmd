...
we aren't rejecting the null hypothesis, there is not enough evidence to reject the null hypothesis.
...
The hypothesis was that voting in 2012 is related. We used a chi-squared test if independace the p value is equal to 0. Therefore, the null hypothesis is rejected. 

We reject the null hypothesis because the p valuie is less than .5, meaning the null hypothesis is related. 

we reject the null since we have evidence that the belief in death penalty is related to the opinion to the court system and if youn do not believe in the edeath penalty it is likely you did n ot believe in the court system.
